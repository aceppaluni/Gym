    ...
    <ScrollView style={styles.view}>
      ...
      <Card containerStyle={styles.second}>
        ...
        <Text style={styles.text}>
          This is one of my favorite suplements! Taking just two of these really
          gave me the pump I was looking for. I combined this product with the
          non-stym pre0workout from bucked up and created the ultimate
